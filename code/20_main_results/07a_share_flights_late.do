* Share of flights late appendix event study
version 18
set more off
...
local out_root "${results_main}/reliability_arrival15"
...
local model_stub "arrival15_maincov_never_dripw"

cd "`out_ster'"
capture noisily csdid2 arrival_15 ${covars_small}, ///
